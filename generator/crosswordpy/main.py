...
def run():
    ...
    chosen_questions = [
        {"clue": j['clue'],
         "answer": j['answer'],
         "start": [chosen_punchlines[j['answer']].startX - best_crossword.minX,
                   chosen_punchlines[j['answer']].startY - best_crossword.minY],
         "end": [chosen_punchlines[j['answer']].endX - best_crossword.minX,
                 chosen_punchlines[j['answer']].endY - best_crossword.minY]
